...
// This is an interface that defines a method onTaskEvent which will be called when a task event happens. The method takes a Task object and a TaskEventType enum as parameters.
// The Task object contains the details of the task that triggered the event, and the TaskEventType enum
